...
import org.example.IGuiInstance;
import org.example.WorldRender;
...
public class GuiRender {
    ...
    private int shaderProgramGUI;
    private Texture texture;
    private UniformsMap uniformsMap;
    private GuiLayer guiLayer;

    public GuiRender(Window window) {
        shaderProgramGUI = ShaderProgramm.shaderMaker("resources/shaders/gui.vert", GL_VERTEX_SHADER, "resources/shaders/gui.frag", GL_FRAGMENT_SHADER);
        createUniforms();
    ...
    private void createUniforms() {
        uniformsMap = new UniformsMap(shaderProgramGUI);
    ...
    public void render(IGuiInstance guiInstance) {
        ...
        guiInstance.drawGui(guiLayer);

        glUseProgram(shaderProgramGUI);
    ...
    private void setupKeyCallBack(Window window) {
        prevKeyCallBack = glfwSetKeyCallback(window.getWindowPointer(), (handle, key, scancode, action, mods) -> {
